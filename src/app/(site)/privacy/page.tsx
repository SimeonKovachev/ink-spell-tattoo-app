            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-6 list-none">
                <li className="bg-gray-800 p-6 rounded-lg">
                  ...
                  <p className="text-gray-400">Type: Session Cookies</p>
                  <p className="text-gray-400">Administered by: Us</p>
                ...
                <li className="bg-gray-800 p-6 rounded-lg">
                  ...
                  <p className="text-gray-400">Type: Persistent Cookies</p>
                  <p className="text-gray-400">Administered by: Us</p>
                  <p className="text-gray-300 mt-2">
