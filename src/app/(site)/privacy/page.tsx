      ...
      <div className="container pt-32 mx-auto py-16 px-4 sm:px-6 lg:px-8 text-gray-300">
        <div className="max-w-3xl mx-auto space-y-8">
              ...
              <ul className="space-y-4 list-disc pl-6">
                ...
                <li>
                  <p>
                    ...
                    също „Компанията“, „Ние“, „Нас“ или „Нашата“ в този договор)
                    се отнася до Ink Spell.
                  </p>
                </li>
                <li>
                  <p>
                    <strong className="text-white">„Бисквитки“</strong> са малки
                    файлове, които се поставят на Вашия компютър или мобилно
                    устройство от уебсайт и съдържат данни за Вашата история на
                    сърфиране.
                  </p>
                </li>
                <li>
          ...
          <section className="space-y-6">
            ...
            <p className="text-gray-300">
              Ние използваме "бисквитки" за събиране на данни за активността в
              нашата Услуга и съхранение на определена информация.
            </p>

            <ul className="space-y-4 list-disc pl-6">
              <li>
                <strong className="text-white">Сесийни "бисквитки"</strong> са
                временно съхранявани и се изтриват при затваряне на браузъра.
              </li>
              <li>
                <strong className="text-white">Постоянни "бисквитки"</strong> са
                запазени дори след затваряне на браузъра.
              </li>
            </ul>
          </section>
