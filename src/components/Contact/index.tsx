      ...
      <div className="container px-4">
        <div className="-mx-4 flex flex-wrap items-center">
            ...
            <div className="ud-contact-content-wrapper">
              ...
              <div className="mb-12 flex flex-wrap justify-between lg:mb-0">
                <div className="mb-8 flex w-[330px] max-w-full">
                  <div className="mr-6 text-[32px] text-accent-purple">
                    <svg
                      width="29"
                      height="35"
                      viewBox="0 0 29 35"
          ...
          <div className="w-full px-4 lg:w-5/12 xl:w-4/12">
            <div
              className="wow fadeInUp rounded-lg px-8 py-10 shadow-testimonial bg-dark-2 dark:shadow-none sm:px-10 sm:py-12 md:p-[60px] lg:p-10 lg:px-10 lg:py-12 2xl:p-[60px]"
              data-wow-delay=".2s
              "
            >
              ...
              <form>
                <div className="mb-[22px]">
                  <label
                    htmlFor="fullName"
                    className="mb-4 block text-sm text-dark-6"
                  >
                    Full Name*
                  </label>
                  <input
                    ...
                    className="w-full border-0 border-b border-[#f1f1f1] bg-transparent pb-3 text-dark placeholder:text-body-color/60 focus:border-accent-purple focus:outline-none dark:border-dark-3 dark:text-white"
                  />
                </div>
                <div className="mb-[22px]">
                  <label
                ...
                <div className="mb-[30px]">
                  ...
                  <textarea
                    ...
                    className="w-full resize-none border-0 border-b border-[#f1f1f1] bg-transparent pb-3 text-dark placeholder:text-body-color/60 focus:border-accent-purple focus:outline-none dark:border-dark-3 dark:text-white"
                  ></textarea>
                </div>
                <div className="mb-0">
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center rounded-md bg-accent-purple px-10 py-3 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-accent-purple/70"
                  >
                    Send
                  </button>
                </div>
